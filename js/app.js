...
import { lessons, kanaData, dictionary, kanjiData, conjugateVerb, kanaStrokes } from './data.js?v=3.4';
import { soundSynth } from './sound.js?v=3.4';
import { TracingCanvas } from './canvas.js?v=3.4';
