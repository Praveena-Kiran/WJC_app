...
module.exports = {
  ...
  rules: {
    ...
    // Prevent any client-side code from importing server-only packages.
    // Metro blockList in metro.config.js provides a second layer of protection.
  ...
  ignorePatterns: ['node_modules/', 'dist/', '.expo/', 'ios/', 'android/', '*.config.js'],
};
